...
container = {
  ...
  x.attr("style", `width:100%; height:${window.innerHeight}px`);
...
The boundaries for public lands are approximate and were obtained from the [PAD-US](https://www.usgs.gov/programs/gap-analysis-project/science/pad-us-data-overview) database or elsewhere.
