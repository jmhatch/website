...
I programmed my AudioMoth to record for 3 hours every morning (5:30 am - 8:30 am) starting on May 12 and ending on June 15. My goal was to understand what birds were using or moving through my backyard during spring migration. I finally got around to processing each recording using [BirdNet-Analyzer](https://github.com/kahst/BirdNET-Analyzer), which can detect bird calls or songs from the audio and assign those calls or songs to species. Below is a graph showing the relative frequency of detected bird occurrences in my backyard over the course of a month (give or take). So cool! 
