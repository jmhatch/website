...
I programmed my AudioMoth to record for 3 hours every morning (5:30 am - 8:30 am) starting on May 12 and ending on June 15. My goal was to understand what birds where using or moving through my backyard during spring migration. I finally got around to processing each recording using [BirdNet-Analyzer](https://github.com/kahst/BirdNET-Analyzer) to detect bird calls or songs from the audio. Below is a graph showing relative frequency of detected bird occurrence in my backyard over the course of a month (give or take). So cool! 
